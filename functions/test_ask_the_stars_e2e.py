...
class TestAskTheStarsEndToEnd:
    ...
    def test_full_entity_extraction_flow(self):
        ...
        extracted = ExtractedEntities(
            entities=[
                ExtractedEntity(
                    ...
                    confidence=1.0,
                    attributes={"relationship_to_user": "partner"},
                    related_to=None
                ),
                ExtractedEntity(
                    name="TechCorp",
        ...
        merged = MergedEntities(
            actions=[
                EntityMergeAction(
                    ...
                    attribute_updates={"relationship_to_user": "partner"}
                ),
                EntityMergeAction(
                    action="create",
        ...
        assert john.attributes["relationship_to_user"] == "partner"
    ...
    def test_entity_attribute_enrichment(self):
        ...
        merged = MergedEntities(
            actions=[
                EntityMergeAction(
                    ...
                    attribute_updates={"birthday_season": "January", "relationship_to_user": "mother"}
                )
            ]
        )
        ...
        assert mom.attributes["birthday_season"] == "January"
        assert mom.attributes["relationship_to_user"] == "mother"
