    ...
    def test_create_new_entity(self):
        ...
        actions = MergedEntities(actions=[
            EntityMergeAction(
                ...
                attribute_updates=[AttributeKV(key="role", value="friend")]
            )
        ])
        ...
        attr_dict = {a.key: a.value for a in result[0].attributes}
        assert attr_dict["role"] == "friend"
    ...
    def test_update_entity_attributes(self):
        ...
        actions = MergedEntities(actions=[
            EntityMergeAction(
                ...
                entity_type="person",
                merge_with_id="ent_001",
                attribute_updates=[AttributeKV(key="birthday_season", value="January")]
            )
        ])
